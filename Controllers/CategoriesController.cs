...
namespace GOVAPI.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        // GET: api/Categories
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Category>>> GetCategory(){ return await _context.Category.ToListAsync(); }
        ...
        {
            return await _context.Category.Include(x => x.Products).AsNoTracking().ToListAsync();
        }
